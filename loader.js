...
function createUnityInstance(t, n, l) {
  ...
  var o,
    b = {
      ...
      wasmFileSize: 41005264,
      cacheControl: function (e) {
        return e == b.dataUrl || e.match(/\.bundle/)
          ? "must-revalidate"
          : "no-store";
      },
  ...
  document.addEventListener("webkitfullscreenchange", u),
    b.deinitializers.push(function () {
      for (var e in (b.disableAccessToMediaDevices(),
      a.forEach(function (e) {
    ...
    (b.QuitCleanup = function () {
      for (var e = 0; e < b.deinitializers.length; e++) b.deinitializers[e]();
      (b.deinitializers = []), "function" == typeof b.onQuit && b.onQuit();
    });
  var f,
    h,
    m,
    ...
    _ = {
      ...
      SetFullscreen: function () {
        if (b.SetFullscreen) return b.SetFullscreen.apply(b, arguments);
        b.print("Failed to set Fullscreen mode: Player not loaded yet.");
      },
      SendMessage: function () {
        if (b.SendMessage) return b.SendMessage.apply(b, arguments);
        b.print("Failed to execute SendMessage: Player not loaded yet.");
      },
      Quit: function () {
        return new Promise(function (e, t) {
          (b.shouldQuit = !0), (b.onQuit = e);
        });
      },
      GetMetricsInfo: function () {
        var e = Number(b._getMetricsInfo()) >>> 0,
          t = 4 + e,
          n = 4 + t,
          r = 8 + n,
          o = 8 + r,
          ...
          u = 4 + d;
        return {
          totalWASMHeapSize: b.HEAPU32[e >> 2],
          usedWASMHeapSize: b.HEAPU32[t >> 2],
          totalJSHeapSize: b.HEAPF64[n >> 3],
          usedJSHeapSize: b.HEAPF64[r >> 3],
          pageLoadTime: b.HEAPU32[o >> 2],
          pageLoadTimeToFrame1: b.HEAPU32[a >> 2],
          fps: b.HEAPF64[i >> 3],
          movingAverageFps: b.HEAPF64[s >> 3],
          assetLoadTime: b.HEAPU32[l >> 2],
          webAssemblyStartupTime:
            b.HEAPU32[c >> 2] - (b.webAssemblyTimeStart || 0),
          codeDownloadTime: b.HEAPU32[d >> 2],
          gameStartupTime: b.HEAPU32[u >> 2],
          numJankedFrames: b.HEAPU32[(4 + u) >> 2],
        };
      },
    };
  function x(e, t, n) {
    -1 == e.indexOf("fullscreen error") &&
      (b.startupErrorHandler
        ? b.startupErrorHandler(e, t, n)
        : (b.errorHandler && b.errorHandler(e, t, n)) ||
  ...
  function S(e, t) {
    if ("symbolsUrl" != e) {
      var n = b.downloadProgress[e],
        ...
        i = 0,
        s = 0;
      for (e in b.downloadProgress) {
        if (!(n = b.downloadProgress[e]).started) return;
        a++,
          n.lengthComputable
  ...
  (b.SystemInfo = (function () {
    ...
    return {
      ...
      hasWasm: m,
      hasWasm2023: b,
      missingWasm2023Feature: b ? null : f(),
      hasWasmThreads: !1,
    };
  })()),
    ...
    (b.readBodyWithProgress = function (a, i, s) {
    ...
    (b.fetchWithProgress = function (e, t) {
      var n = function () {};
      return (
        t && t.onProgress && (n = t.onProgress),
        fetch(e, t).then(function (e) {
          return b.readBodyWithProgress(e, n, t.enableStreamingDownload);
        })
      );
    }),
    (b.UnityCache =
      ...
      (E.UnityCacheDatabase = f),
      (E.RequestMetaDataStore = h),
        ...
        return void 0 === g
          ...
          : void 0 === window.caches
            ...
            : new Promise(function (t, n) {
                try {
                  ...
                  o.openDBTimeout = setTimeout(function () {
                    void 0 === o.database &&
                      n(
                        new Error(
                          "Could not connect to cache: Database timeout.",
                        ),
                      );
                  }, 2e4);
                  var e = g.open(f.name, f.version);
                ...
                .then(function () {
                  var e = f.name + "_" + b.companyName + "_" + b.productName;
                    ...
                    if (e)
                      return (
                        ...
                        new Promise(function (e, t) {
                          var n = i.database.transaction([h.name], "readwrite");
    ...
    (b.cachedFetch =
      ((v = b.UnityCache),
      (y = b.fetchWithProgress),
      (k = b.readBodyWithProgress),
      function (o, a) {
        var e,
          t,
          i = v.getInstance(),
              ...
              : 304 === e.status
                ...
                : 200 == e.status
                  ? ((l.response = e),
                    ...
                    (l.revalidated = !0),
                    (t = e.clone()),
                    k(e, r.onProgress, r.enableStreamingDownload).then(
                      function (e) {
                        return (
              ...
              function i(e) {
                ...
                return e && e.state
                  ? ((t = e.state),
                    ...
                    (t.hold = 0),
                    (t.bits = 0),
                    (t.lencode = t.lendyn = new D.Buf32(r)),
                    (t.distcode = t.distdyn = new D.Buf32(o)),
                    (t.sane = 1),
                    (t.back = -1),
                    L)
                  : O;
              ...
              function Z(e, t, n, r) {
                ...
                return (
                  null === (e = e.state).window &&
                    ...
                    (e.wnext = 0),
                    (e.whave = 0),
                    (e.window = new D.Buf8(e.wsize))),
                  r >= e.wsize
                    ? (D.arraySet(e.window, t, n - e.wsize, e.wsize, 0),
                      (e.wnext = 0),
                      (e.whave = e.wsize))
                    : (r < (o = e.wsize - e.wnext) && (o = r),
                      D.arraySet(e.window, t, n - r, o, e.wnext),
                      (r -= o)
                        ? (D.arraySet(e.window, t, n - r, r, 0),
                          (e.wnext = r),
                          (e.whave = e.wsize))
                        : ((e.wnext += o),
                  ...
                  e: for (;;)
                    switch (n.mode) {
                        ...
                        if (
                          ...
                          ((h = s < (h = n.length) ? s : h) &&
                            (n.head &&
                              ...
                              D.arraySet(n.head.extra, r, a, h, _)),
                            512 & n.flags && (n.check = R(n.check, r, h, a)),
                            (s -= h),
                            (a += h),
                            (n.length -= h)),
                          n.length)
                      ...
                      case 10:
                        ...
                        (e.adler = n.check = N(c)), (d = c = 0), (n.mode = 11);
                      case 11:
                        if (0 === n.havedict)
                          return (
                            (e.next_out = i),
                            ...
                            case 1:
                              ...
                              if (W) {
                                ...
                                for (
                                  ...
                                  P.lens[T++] = 5;
                                z(2, P.lens, 0, 32, M, 0, P.work, { bits: 5 }),
                                  (W = !1);
                              }
                              if (
                                ((P.lencode = H),
                      ...
                      case 18:
                        ...
                        if (
                          ...
                          (n.lenbits = 7),
                          (S = { bits: n.lenbits }),
                          (x = z(0, n.lens, 0, 19, n.lencode, 0, n.work, S)),
                          (n.lenbits = S.bits),
                          x)
                        ) {
                      ...
                      case 27:
                        if (n.wrap) {
                          ...
                          if (
                            ...
                            f &&
                              (e.adler = n.check =
                                (n.flags ? R : B)(n.check, o, f, i - f)),
                            (f = l),
                            (n.flags ? c : N(c)) !== n.check)
                          ) {
                    ...
                    Z(e, e.output, e.next_out, f - e.avail_out)
                      ...
                      : ((u -= e.avail_in),
                        ...
                        n.wrap &&
                          f &&
                          (e.adler = n.check =
                            (n.flags ? R : B)(n.check, o, f, e.next_out - f)),
                        (e.data_type =
                          n.bits +
                          (n.last ? 64 : 0) +
                          (12 === n.mode ? 128 : 0) +
            ...
            "zlib/inftrees.js": function (e, t, n) {
              ...
              t.exports = function (e, t, n, r, o, a, i, s) {
                for (
                  ...
                  P[w] = 0;
                for (v = 0; v < r; v++) P[t[n + v]]++;
                for (_ = g, k = 15; 1 <= k && 0 === P[k]; k--);
                if ((k < _ && (_ = k), 0 === k))
                  (o[a++] = 20971520), (o[a++] = 20971520), (s.bits = 1);
                else {
                  for (y = 1; y < k && 0 === P[y]; y++);
                  for (_ < y && (_ = y), w = E = 1; w <= 15; w++)
                    if ((E = (E <<= 1) - P[w]) < 0) return -1;
                  if (0 < E && (0 === e || 1 !== k)) return -1;
                  for (D[1] = 0, w = 1; w < 15; w++) D[w + 1] = D[w] + P[w];
                  for (v = 0; v < r; v++)
                    0 !== t[n + v] && (i[D[t[n + v]]++] = v);
                  if (
                    ((h =
    ...
    br: {
      hasUnityMarker: function (e) {
        ...
        if (
          ...
          return !1;
        for (
          var a = r + ((6 + (o << 4) + ((t.length - 1) << 6)) << n), i = 0;
          i < commentOffset;
          i++, a >>>= 8
        )
  ...
  function T(t) {
    S(t);
    var e = b.cacheControl(b[t]),
      n = b.companyName && b.productName ? b.cachedFetch : b.fetchWithProgress,
      r = b[t],
  ...
  function P() {
    var t = performance.now(),
      m =
        (Promise.all([
          T("frameworkUrl").then(function (e) {
                ...
                (i.onload = function () {
                  if ("undefined" == typeof unityFramework || !unityFramework) {
                    ...
                    for (e in t) {
                      var n,
                        r = t[e];
                      if (b.frameworkUrl.endsWith("." + r[0]))
                        return (
                          (n = "Unable to parse " + b.frameworkUrl + "!"),
                          "file:" == location.protocol
                            ? void c(
                                n +
          ...
          (b.wasmBinary = e[1]),
            e[0](b),
            (b.codeDownloadTimeEnd = performance.now() - t);
        }),
        performance.now()),
      e = T("dataUrl");
          ...
          for (
            ...
            var l = r(),
              ...
              u =
                ...
                e.decode(t.subarray(n, n + d)));
            n += d;
            for (
              var f = 0, h = u.indexOf("/", f) + 1;
              0 < h;
              f = h, h = u.indexOf("/", f) + 1
            )
              b.FS_createPath(u.substring(0, f), u.substring(f, h - 1), !0, !0);
            b.FS_createDataFile(u, null, t.subarray(l, l + c), !0, !0, !0);
          }
          b.removeRunDependency("dataUrl"),
            (b.dataUrlLoadEndTime = performance.now() - m);
        });
    });
  }
  return new Promise(function (e, t) {
    var n;
    b.SystemInfo.hasWebGL
      ? 1 == b.SystemInfo.hasWebGL
        ? ((n =
            'Your browser does not support graphics API "WebGL 2" which is required for this content.'),
          "Safari" == b.SystemInfo.browser &&
            parseInt(b.SystemInfo.browserVersion) < 15 &&
            (b.SystemInfo.mobile || 1 < navigator.maxTouchPoints
              ? (n += "\nUpgrade to iOS 15 or later.")
              : (n += "\nUpgrade to Safari 15 or later.")),
          t(n))
        : b.SystemInfo.hasWasm
          ? ((b.startupErrorHandler = t),
            ...
            b.postRun.push(function () {
              l(1),
                ...
                e(_),
                (b.pageStartupTime = performance.now());
            }),
            new Promise(function (t, e) {
              navigator.gpu
                ? navigator.gpu.requestAdapter().then(function (e) {
                    (b.SystemInfo.hasWebGPU = !!e), t(b.SystemInfo.hasWebGPU);
                  })
                : t(!1);
            }).then(function () {
              P();
